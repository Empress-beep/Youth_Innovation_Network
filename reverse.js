...
// 私钥
var _0x35356d = '-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----'
...
// 加密函数
function get_data(page, qccppm, qccrkeys) {
    window.qccrkeys = qccrkeys;
    _0x265ee2 = window["qccrkeys"][1];
    _0x903ee5 = window["qccrkeys"][7];
    ...
    _0x2855b1 = _0x510f65[0];
    _0x2016ce = _0x510f65[1];
    _0x359c94 = _0x510f65[2];

    // Content加密
    _0x247919 = _0xdc84c4(JSON.stringify(_0x487903));
    // Sign加密
    var _0x21c377 = _0x724be5(_0x247919);

    _0x556f40 = '-----BEGIN PUBLIC KEY-----\nMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCfRaEDlCfTesGs4B+cR94FLmBInsK+ZBs9bTbgYII2TfFvrJVaLvagt+TLucqaNmBMFqQ3SlD6oDcujXdZ4+74PEiUU57xj733Q0QnlUEJhvG+URg62bDWSs7v28J4bP3zvKd1+kaYj3yMTWxPB+tEV6XFkPvfbYuI/dmqXNXZWQIDAQAB\n-----END PUBLIC KEY-----'
    _0x199b58 = eval("new JSEncrypt()");
    _0x199b58.setPublicKey(_0x556f40)
...
// 解密函数
function decrypt_data(res, qccppm){
    var _0x510f65 = qccppm["split"]("|");
    _0x2855b1 = _0x510f65[0];
    _0x2016ce = _0x510f65[1];
    // _0x359c94 = _0x510f65[2];
    data = JSON.parse(_0x528645(res))
